...
{ref}/security-settings.html#ref-saml-settings[SAML realm settings], this guide 
will walk you through the most common settings.
...
See {ref}/configuring-saml-realm.html[Configuring a SAML realm]. 
