...
tag::latest[]
//TBD
A method for transforming the data, which finds the latest document for each
unique key.
end::latest[]
...
tag::pivot[]
A method for transforming the data, which aggregates and groups the data. These 
objects define the pivot function `group by` fields and the aggregation to
reduce the data.
end::pivot[]
