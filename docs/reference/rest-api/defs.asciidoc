...
* <<transform-resource,{dataframe-transforms-cap}>>
* <<transform-resource-stats,{dataframe-transforms-cap} statistics>>
...
include::{es-repo-dir}/data-frames/apis/transform-resource.asciidoc[]
include::{es-repo-dir}/data-frames/apis/transform-resource-stats.asciidoc[]
