...
the list of seed nodes for <<modules-discovery,discovery>>: a _settings_-based
and a _file_-based hosts provider. It can be extended to support cloud
environments and other forms of hosts providers via
