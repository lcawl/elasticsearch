[[modules-discovery-cluster-formation]]
...
<<modules-discovery-bootstrap-cluster>>::
    ...
    configured via the
    <<modules-discovery-bootstrap-cluster,`cluster.initial_master_nodes` setting>>.
...
include::discovery/voting-configurations.asciidoc[]

include::discovery/master-elections.asciidoc[]
